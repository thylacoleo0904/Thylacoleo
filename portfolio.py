"""
Portfolio-tracker. Omdat Thylacoleo zelf niet handelt (jij drukt op de knop),
...
def log_trade(symbol: str, trade_type: str, prijs: float, hoeveelheid: float, kosten_eur: float = 0.0):
    ...
    Voeg een trade toe die je ZELF hebt uitgevoerd (na een Thylacoleo-signaal of los).
    """
